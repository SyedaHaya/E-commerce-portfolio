...
export const SignUp = () => {
    ...
    const handleSignup = (event) => {
        ...
        if (password !== confirmPassword) {
            seterrorMassage("Password does not match! Please, provide a correct password!")
        } else {
            seterrorMassage("");
            createUser(email, password).then((userCredential) => {
                const user = userCredential.user;
                alert(user, "Account created suceessfully done!!!")
                // navigat(from, { replace: true })
                navigat('/')
            }).catch((error) => {
            ...
            <div className="container">
                <div className="account-wrapper">
                    ...
                    <form className='account-form' onSubmit={handleSignup}>
                        ...
                        < div className="form-group">
                            <input type='password' name='confirmPassword' id='confrimPassword' placeholder='Confrim Password' required />
                        </div>
                        <div>
                            {
                                errorMassage && (
